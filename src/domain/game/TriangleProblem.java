...
/**
 * Implementation of the abstract {@link Problem} class. A problem with fields in the shape of triangles. In these kind
 * of maps, different types of adjacency exist: faces only or also edges (diagonally).
 *
 * @author Samuel Hoenle
 */

public class TriangleProblem extends Problem implements Serializable{

    private boolean cornerAdjacent;

    /**
     * Default constructor for a triangle problem. In addition to calling the default constructor of {@link Problem},
     * the type of adjacency is also set.
     *
     ...
     */
    public TriangleProblem(String[][] map, int numRows, int numColumns, Difficulty difficulty, String creatorName, boolean cornerAdjacent) {
    ...
    @Override
    public int hashCode() {
        return 51*super.hashCode() + (cornerAdjacent ? 1 : 0);
    }
    ...
    public boolean equals(Object o) {
        ...
        TriangleProblem problem = (TriangleProblem) o;
